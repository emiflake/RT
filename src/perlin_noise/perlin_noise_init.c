...
/*   Updated: 2019/11/18 16:10:51 by jandre-d      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
** This is a randomly arranged array of all numbers in range 0-255 inclusive.
*/

static int *create_lookup_table(int *from)
{
	int	*result;
	int	i;
	
	result = malloc(sizeof(int) * 512);
	i = 0;
	if (result == NULL)
		return (NULL);
	while (i < 512)
...
bool	perlin_noise_init(t_perlin_noise *p_noise)
{
	int my_array[] = {
